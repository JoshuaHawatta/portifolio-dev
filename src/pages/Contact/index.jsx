  ...
  <ArticleWrapper id='contact-article'>
    <CARD_JSX>
      ...
      <ConctatsWrapper>
        ...
        <a href='https://wa.me/5561996760337' target='_blank'>
          <CTA_BUTTON_JSX icon={<FaWhatsapp />} text='WhatsApp' color='25D366' btnWidth='100%' />
        </a>

        <a href='https://www.instagram.com/joshuahawatta/' target='_blank'>
          <CTA_BUTTON_JSX icon={<FaInstagram />} text='Instagram' color='833AB4' btnWidth='100%' />
        </a>

        <a href='https://linkedin.com/in/joshua-hawatta' target='_blank'>
          <CTA_BUTTON_JSX icon={<FaLinkedin />} text='LinkedIn' color='0077b5' btnWidth='100%' />
        </a>
      </ConctatsWrapper>
    </CARD_JSX>
  </ArticleWrapper>
